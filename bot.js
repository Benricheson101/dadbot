...
function startupSequence() {
  ...
  //   )}*/ `Shards:  ${
  //     Number(process.env.lastShardId) - Number(process.env.firstShardId) + 1
  //   }`,
  //   process.env.lastShardId,
  //   Number(process.env.lastShardId),
  //   typeof process.env.lastShardId
  // );
